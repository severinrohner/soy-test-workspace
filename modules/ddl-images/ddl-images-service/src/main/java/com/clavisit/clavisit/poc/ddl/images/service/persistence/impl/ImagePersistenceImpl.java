...
package com.clavisit.clavisit.poc.ddl.images.service.persistence.impl;
...
import com.clavisit.clavisit.poc.ddl.images.model.impl.ImageModelImpl;
 ...
 * @see com.clavisit.clavisit.poc.ddl.images.service.persistence.ImageUtil
 * @generated
 */
@ProviderType
public class ImagePersistenceImpl extends BasePersistenceImpl<Image>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(ImageModelImpl.ENTITY_CACHE_ENABLED,
			ImageModelImpl.FINDER_CACHE_ENABLED, ImageImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(ImageModelImpl.ENTITY_CACHE_ENABLED,
			ImageModelImpl.FINDER_CACHE_ENABLED, ImageImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			ImageModelImpl.UUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(ImageModelImpl.ENTITY_CACHE_ENABLED,
			ImageModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Image findByUuid_First(String uuid,
	 ...
	 */
	@Override
	public Image fetchByUuid_First(String uuid,
		OrderByComparator<Image> orderByComparator) {
	 ...
	 */
	@Override
	public Image findByUuid_Last(String uuid,
		OrderByComparator<Image> orderByComparator) throws NoSuchImageException {
	 ...
	 */
	@Override
	public Image fetchByUuid_Last(String uuid,
		OrderByComparator<Image> orderByComparator) {
		...
		List<Image> list = findByUuid(uuid, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public Image[] findByUuid_PrevAndNext(long imageId, String uuid,
		OrderByComparator<Image> orderByComparator) throws NoSuchImageException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, image, uuid,
					orderByComparator, true);

			array[1] = image;

			array[2] = getByUuid_PrevAndNext(session, image, uuid,
	...
	protected Image getByUuid_PrevAndNext(Session session, Image image,
	...
	public void removeByUuid(String uuid) {
		for (Image image : findByUuid(uuid, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "image.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "image.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(image.uuid IS NULL OR image.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(ImageModelImpl.ENTITY_CACHE_ENABLED,
			ImageModelImpl.FINDER_CACHE_ENABLED, ImageImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			ImageModelImpl.UUID_COLUMN_BITMASK |
			ImageModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(ImageModelImpl.ENTITY_CACHE_ENABLED,
			ImageModelImpl.FINDER_CACHE_ENABLED, Long.class,
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((image.getUuid() == null) ||
							!image.getUuid().equals(uuid) ||
							(image.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, image);
					}
				}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "image.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "image.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(image.uuid IS NULL OR image.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "image.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(ImageModelImpl.ENTITY_CACHE_ENABLED,
			ImageModelImpl.FINDER_CACHE_ENABLED, ImageImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(ImageModelImpl.ENTITY_CACHE_ENABLED,
			ImageModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Image> findByUuid_C(String uuid, long companyId, int start,
		int end) {
	 ...
	 */
	@Override
	public Image findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<Image> orderByComparator) throws NoSuchImageException {
	 ...
	 */
	@Override
	public Image fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator<Image> orderByComparator) {
		List<Image> list = findByUuid_C(uuid, companyId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Image findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<Image> orderByComparator) throws NoSuchImageException {
	 ...
	 */
	@Override
	public Image fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<Image> orderByComparator) {
		...
		List<Image> list = findByUuid_C(uuid, companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Image[] findByUuid_C_PrevAndNext(long imageId, String uuid,
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, image, uuid, companyId,
					orderByComparator, true);

			array[1] = image;

			array[2] = getByUuid_C_PrevAndNext(session, image, uuid, companyId,
					orderByComparator, false);
	...
	protected Image getByUuid_C_PrevAndNext(Session session, Image image,
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (Image image : findByUuid_C(uuid, companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(image);
		}
	}
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "image.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "image.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(image.uuid IS NULL OR image.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "image.companyId = ?";
	...
	public void clearCache(Image image) {
		...
		clearUniqueFindersCache((ImageModelImpl)image);
	}
	...
	protected void clearUniqueFindersCache(ImageModelImpl imageModelImpl) {
		Object[] args = new Object[] {
				imageModelImpl.getUuid(), imageModelImpl.getGroupId()
			};
	...
	public Image updateImpl(Image image) {
		...
		clearUniqueFindersCache(imageModelImpl);
		cacheUniqueFindersCache(imageModelImpl, isNew);
	...
	protected Image toUnwrappedModel(Image image) {
		...
		imageImpl.setUuid(image.getUuid());
		...
		imageImpl.setFileName(image.getFileName());
		imageImpl.setDescription(image.getDescription());
		imageImpl.setImagePath(image.getImagePath());
		imageImpl.setThumbnailPath(image.getThumbnailPath());
		imageImpl.setFileEnding(image.getFileEnding());
		imageImpl.setMimeType(image.getMimeType());
