...
public class ImageServiceHttp {
	public static java.util.List<com.clavisit.clavisit.poc.ddl.images.model.Image> findFileEntries(
		...
		try {
			MethodKey methodKey = new MethodKey(ImageServiceUtil.class,
					"findFileEntries", _findFileEntriesParameterTypes0);
			...
			return (java.util.List<com.clavisit.clavisit.poc.ddl.images.model.Image>)returnObj;
		}
	...
	private static final Class<?>[] _findFileEntriesParameterTypes0 = new Class[] {
